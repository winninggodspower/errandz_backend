...
from notification.fcm_notifications import FCMNotification
...
class Delivery(models.Model):
    ...
    rider_who_accepted = models.ForeignKey(
    ...
    def accept_request(self, account: Account):
        ...
        self.rider_who_accepted = account.get_account_type_model()
    ...
    def confirm_delivery(self, ref):
        ...
        for account in [delivery_model.customer, delivery_model.rider_who_accepted]:
            ...
            if account.account.notification_token:

                FCMNotification().send_notification(

                    account.account.notification_token,

                    {

                        "title": f"{delivery_model.recievers_name} received her/his goods",

                        "body": f"{delivery_model.recievers_name} received her/his goods",
...
class Notification(models.Model):
    ...
    model = models.ForeignKey(Delivery, blank=True,
